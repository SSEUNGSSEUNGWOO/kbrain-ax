    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm rounded-2xl border border-secondary bg-card p-8 shadow-sm">
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-muted-foreground">Google 계정으로 로그인하세요</p>
        </div>

        <button
          onClick={handleGoogleLogin}
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-secondary bg-background px-4 py-3 text-sm font-medium transition hover:bg-muted"
        >
